...
botStart = time.time()
cl = LINE("alexisr78megonzalez@yahoo.com","mvp168")
k1 = LINE("alexisv8x50martinez@yahoo.com","mvp168")
k2 = LINE("lilyydpbejackson@yahoo.com","mvp168")
k3 = LINE("kayleevujh1taylor@yahoo.com","mvp168")
k4 = LINE("savannahhkfdaking@yahoo.com","mvp168")
k5 = LINE("jfa60652326lg@163.com","mvp168")
k6 = LINE("destinyv31j9perez@yahoo.com","mvp168")
k7 = LINE("isabellarovq3anderson@yahoo.com","mvp168")
k8 = LINE("mariax9q4iphillips@yahoo.com","mvp168")
k9 = LINE("emilydtq3hlee@yahoo.com","mvp168")
k10 = LINE("sophia70vfcwilson@yahoo.com","mvp168")
g1 = LINE("miaskjyvwalker@yahoo.com","mvp168")
g2 = LINE("faithb203ewilliams@yahoo.com","mvp168")
print ("[ 登錄系統 ]成功(  -᷄ω-᷅ )")
...
oepoll = OEPoll(cl)
call = cl
creator = ["uce1998e5234d2ce42c22c1a4990feed4","u0f3ff7c8aba42b6725638265658aa5b1"]
owner = ["uce1998e5234d2ce42c22c1a4990feed4","u0f3ff7c8aba42b6725638265658aa5b1"]
admin = ["uce1998e5234d2ce42c22c1a4990feed4","u0f3ff7c8aba42b6725638265658aa5b1"]
staff = ["uce1998e5234d2ce42c22c1a4990feed4"]
#==============================================================================
...
def help():
    ...
    helpMessage += "┃" + " ├───༼購買找 line ID: yui55529༽──\n"
    helpMessage += "┃" + " ├──────────────\n"
    helpMessage += "╠❂➣ %i. " % num + key + "我\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "我的創作者\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "招待\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "速度\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "員工速度\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "保護清單\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "報數\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "Get id @\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "查 @\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "關於\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "本群資訊\n"
    num = (num+1)   
    helpMessage += "╠❂➣ %i. " % num + key + "所有員工\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "運行時間\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "群清單\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "更改群圖片\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "群清單\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "我的員工\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "清除黑名單\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "刷新\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "運行時間\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "重啟\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "廣播: \n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "所有保護群組\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "標記\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "員工清單\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "權限者清單\n"
    num = (num+1)   
    helpMessage += "╠❂➣ %i. " % num + key + "踢 @\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "王踢 @\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "小兵踢 @\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "刷新 \n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "黑名單清單 \n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "名片新增管理員 \n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "新增管理員 @\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "刪除管理員 \n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "新增員工 @\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "刪除員工 @\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "名片新增員工 \n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "名片刪除員工 \n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "新增機器人 @\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "刪除機器人 @\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "名片新增機器人 \n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "名片刪除機器人 \n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "掰1-掰10\n"
    num = (num+1)  
    helpMessage += "╠❂➣ %i. " % num + key + "小兵退\n"
    num = (num+1) 
    helpMessage += "╠❂➣ %i. " % num + key + "主退\n"
    num = (num+1) 
    helpMessage += "╠❂➣ %i. " % num + key + "開網址\n"
    num = (num+1) 
    helpMessage += "╠❂➣ %i. " % num + key + "關網址\n"
    num = (num+1) 
    helpMessage += "╠❂➣ %i. " % num + key + "主機:/兵1-12:(更換名稱)\n"
    num = (num+1) 
    helpMessage += "╠❂➣ %i. " % num + key + "換圖片1-10up\n"
    num = (num+1) 
    helpMessage += "╠❂➣ %i. " % num + key + "更換群圖片\n"
    num = (num+1) 
    helpMessage += "╠❂➣ %i. " % num + key + "更換所有兵圖片\n"
    num = (num+1) 
    helpMessage += "╠❂➣ %i. " % num + key + "待命\n"
    num = (num+1) 
    helpMessage += "╠❂➣ %i. " % num + key + "待命2\n"
    num = (num+1) 
    helpMessage += "╠❂➣ %i. " % num + key + "新增黑名單 @\n"
    num = (num+1) 
    helpMessage += "╠❂➣ %i. " % num + key + "刪除黑名單\n"
    num = (num+1) 
    helpMessage += "╠❂➣ %i. " % num + key + "名片刪除黑單\n"
    num = (num+1) 
    helpMessage += "╠❂➣ %i. " % num + key + "清除黑名單\n"
    num = (num+1) 
    helpMessage += "╠❂➣ %i. " % num + key + "黑單名片\n"
    num = (num+1) 
    helpMessage += "╠❂➣ %i. " % num + key + "殺黑單\n"
    num = (num+1) 
    helpMessage += "╠❂➣ %i. " % num + key + "保護裝置\n"
    num = (num+1) 
    helpMessage += "╠❂➣ %i. " % num + key + "重啟\n"
    num = (num+1) 
    helpMessage += "┃ " + "├──────────────\n"
    helpMessage += "┃ " + "╰──⍟✿タイガーファミリー_デビッド✿⍟──\n"
    helpMessage += "╰━━━━━━━━━━━━━━━━"
    helpMessage += " Creator: 購買找 line ID: yui55529 \n"
    return helpMessage
...
def helpbot():
    ...
    num = (num+1)
    helpMessage2 += "╠❂➣ %i. " % num + key + "Sider on/off\n"
    num = (num+1)
    ...
    helpMessage2 += "╰━━━━━━━━━━━━━━━━"
    helpMessage2 += " My ID LINE : 〘 ID :  yui55529 〙\n"
    return helpMessage2
                                                ...
                                                try:
                                                   ...
                                                   for target in inv2:
                                                    ...
                                                    try:
                                                        ...
                                                        inv2 = inv1.split(',')
                                                        for target in inv2:
                                                            k9.cancelGroupInvitation(op.param1, [target])
                                                            k9.kickoutFromGroup(op.param1, [op.param2])
                                                            bl["blacklist"][op.param2] = True
                                                    except:
                                                        try:
                                                            ...
                                                            inv2 = inv1.split(',')
                                                            for target in inv2:
                                                                k10.cancelGroupInvitation(op.param1, [target])
                                                                k10.kickoutFromGroup(op.param1, [op.param2])
                                                                bl["blacklist"][op.param2] = True
                                                        except:
                                                   	       pass						
...
#SC UPDATE FOTO
               ...
               if msg.contentType == 0:
                    ...
                    if text is None:
                        ...
                        elif cmd == "我的創作者" or text.lower() == 'creator':
                            if msg._from in owner or msg._from in admin or msg._from in staff:
                        ...
                        elif cmd == "關於" or cmd == "informasi":
                          if wait["selfbot"] == True:
                            if msg._from in owner or msg._from in admin:
                               sendMention(msg.to, sender, "ᴍʏ ᴄʀᴇᴀᴛᴏʀ\n\n")
                               cl.sendMessage(msg.to, None, contentMetadata={'mid': mid}, contentType=13)

                        elif cmd == "我" or text.lower() == 'me':
                          if wait["selfbot"] == True:
                            if msg._from in owner or msg._from in admin or msg._from in staff:                                           
                                msg.contentType = 13
                        ...
                        elif cmd == "#清除黑名單" or text.lower() == '#hapusbl':
                          if wait["selfbot"] == True:
                            if msg._from in admin:                          	
                              wait["blacklist"] = {}            
...
#===========BOT UPDATE============#
                         ...
                         if msg._from in admin:
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               k1.sendMessage(msg.to, "۞❂✪✿✿ タイガーファミリー_デビッド ✿✿➲➤")
                               k2.sendMessage(msg.to, "۞❂✪✿✿ タイガーファミリー_デビッド ✿✿➲➤")
                               k3.sendMessage(msg.to, "۞❂✪✿✿ タイガーファミリー_デビッド ✿✿➲➤")
                               k4.sendMessage(msg.to, "۞❂✪✿✿ タイガーファミリー_デビッド ✿✿➲➤")
                               k5.sendMessage(msg.to, "۞❂✪✿✿ タイガーファミリー_デビッド ✿✿➲➤")
                               k6.sendMessage(msg.to, "۞❂✪✿✿ タイガーファミリー_デビッド ✿✿➲➤")
                               k7.sendMessage(msg.to, "۞❂✪✿✿ タイガーファミリー_デビッド ✿✿➲➤")
                               k8.sendMessage(msg.to, "۞❂✪✿✿ タイガーファミリー_デビッド ✿✿➲➤")
                               k9.sendMessage(msg.to, "۞❂✪✿✿ タイガーファミリー_デビッド ✿✿➲➤")
                               k10.sendMessage(msg.to, "۞❂✪✿✿ タイガーファミリー_デビッド ✿✿➲➤")
...
#====================================#
                        elif cmd == "名片新增管理員" or text.lower() == 'admin:on':
                            if msg._from in owner:
                                wait["addadmin"] = True
                                cl.sendMessage(msg.to,"Send Contact")

                        elif cmd == "刪除管理員" or text.lower() == 'adminexpl:on':
                            if msg._from in owner:
                                wait["delladmin"] = True
                                cl.sendMessage(msg.to,"Send contact")

                        elif cmd == "名片新增員工" or text.lower() == 'staff:on':
                            if msg._from in owner or msg._from in admin:
                                wait["addstaff"] = True
                                cl.sendMessage(msg.to,"Send contact")

                        elif cmd == "名片刪除員工" or text.lower() == 'staffexpl:on':
                            if msg._from in owner or msg._from in admin:
                                wait["dellstaff"] = True
                                cl.sendMessage(msg.to,"Send contact")

                        elif cmd == "名片新增機器人" or text.lower() == 'bot:on':
                            if msg._from in owner or msg._from in admin:
                                wait["addbots"] = True
                                cl.sendMessage(msg.to,"Send contact")

                        elif cmd == "名片刪除機器人" or text.lower() == 'botexpl:on':
                            if msg._from in owner:
                                wait["dellbots"] = True
                                cl.sendMessage(msg.to,"Kirim kontaknya...")

                        elif cmd == "刷新" or text.lower() == 'refresh':
                            if msg._from in owner or msg._from in admin or msg._from in staff:
                                wait["addadmin"] = False
...
#===========COMMAND BLACKLIST============#
                        ...
                        elif cmd == "名片刪除黑單" or text.lower() == 'ban:on':
                          if wait["selfbot"] == True:
                            if msg._from in owner or msg._from in admin:
                                wait["wblacklist"] = True
                                cl.sendMessage(msg.to,"Send contact")

                        elif cmd == "刪除黑名單" or text.lower() == 'unban:on':
                          if wait["selfbot"] == True:
                            if msg._from in owner or msg._from in admin:
                                wait["dblacklist"] = True
                                cl.sendMessage(msg.to,"Send contact")

                        elif cmd == "黑名單清單" or text.lower() == 'banlist':
                          if wait["selfbot"] == True:
                            if msg._from in owner or msg._from in admin:
                              if wait["blacklist"] == {}:
                        ...
                        elif cmd == "黑單名片" or text.lower() == 'bl':
                          if wait["selfbot"] == True:
                            if msg._from in owner:
                              if wait["blacklist"] == {}:
                        ...
                        elif cmd == "清除黑名單" or text.lower() == 'cbl':
                          if wait["selfbot"] == True:
                            if msg._from in creator or msg._from in owner or msg._from in admin:
                              cl.sendMessage(msg.to,"Succes Bersihkan {} Daftar Blacklist".format(str(len(wait["blacklist"]))))
                              wait["blacklist"] = {}
